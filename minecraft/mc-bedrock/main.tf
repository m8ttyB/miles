...
Features
- Runs [itzg/minecraft-server](https://hub.docker.com/r/itzg/minecraft-bedrock-server) Docker image
...
locals {
  ...
  minecraft_switch_access_group = "<groups_name>@googlegroups.com"
}
...
resource "google_compute_instance" "minecraft" {
  ...
  # Run itzg/minecraft-bedrock-server docker image on startup
  # The instructions: https://hub.docker.com/r/itzg/minecraft-bedrock-server
  ...
  metadata_startup_script =  "docker run -d -it -e EULA=TRUE -e LEVEL_TYPE=default -e GAMEMODE=survival -p 19132:19132/udp --name mc itzg/minecraft-bedrock-server:latest;"
