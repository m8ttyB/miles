...
motor_label = label.Label(terminalio.FONT, text="Motor off", color=0xFF0000, max_glyphs=13)
motor_label.x = 4
motor_label.y = 74
...
def water_five_times():
    for i in range(5):
        motor.value = True
        motor_label.text = "Thirsty"
...
while True:
    ...
    if aperc < moist_level and counter < 0:
        # reset counter to 15 minutes
        counter = 900
